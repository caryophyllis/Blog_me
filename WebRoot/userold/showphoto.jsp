	...
	<div id="wrapper">
		<div id="container">
			<div id="scene">
				...
				<h1>${empty sessionScope.blogtitle ? "博客网站系统":sessionScope.blogtitle}
					<br /> <font size="8">${empty sessionScope.idiograph ? "我的签名":sessionScope.idiograph}</font>
				</h1>
				<div id="scale_area">
				...
				<div id="menu">
					<div class="holder">
						<a href="../showAllArticle.action">博客首页</a>
					</div>
					<div class="holder">
						<a href="showUserAllArticle.action">用户首页</a>
					</div>
					<div class="holder">
								...
								<tr>
									<s:iterator value="#request.photoList" id="photo" status="stu">
										<td><a
											...
											title="我的相册" rel="gb_imageset[photos]"> <img
