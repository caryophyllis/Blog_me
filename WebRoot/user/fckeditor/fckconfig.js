...
//FCKConfig.CustomConfigurationsPath = '/BFblogDemo02/user/fckeditor/myconfig.js' ;
...
FCKConfig.Keystrokes = [ [ CTRL + 65 /* A */, true ],
		[ CTRL + 67 /* C */, true ], [ CTRL + 70 /* F */, true ],
		[ CTRL + 83 /* S */, true ], [ CTRL + 84 /* T */, true ],
		[ CTRL + 88 /* X */, true ], [ CTRL + 86 /* V */, 'Paste' ],
		[ CTRL + 45 /* INS */, true ], [ SHIFT + 45 /* INS */, 'Paste' ],
		[ CTRL + 88 /* X */, 'Cut' ], [ SHIFT + 46 /* DEL */, 'Cut' ],
		[ CTRL + 90 /* Z */, 'Undo' ], [ CTRL + 89 /* Y */, 'Redo' ],
		[ CTRL + SHIFT + 90 /* Z */, 'Redo' ], [ CTRL + 76 /* L */, 'Link' ],
		[ CTRL + 66 /* B */, 'Bold' ], [ CTRL + 73 /* I */, 'Italic' ],
		[ CTRL + 85 /* U */, 'Underline' ],
...
FCKConfig.SmileyWindowWidth = 400;// 弹出窗口宽度
FCKConfig.SmileyWindowHeight = 200;// 弹出窗口高度
