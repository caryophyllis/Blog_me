...
<body>
	<div class="head">
		<ul class="navlist">
			<li><a class="show_login" href="../login.jsp"><img src="../img/home.png" /></a>
				<a href="../user/showUserAllArticle.action"><img src="../img/message.png" /></a> 
				<a href="../showAllArticle.action"><img src="../img/bloginfo.png" /></a> 
				<a href="showPhoto.action"><img src="../img/picture.png" /></a> 
				<a href="addArticle.jsp"><img src="../img/music.png" /></a> 
	...
	<div class="blog_content">
				...
				<s:iterator value="#request.all" id="art" status="sta">
					<div class="comments">
						<div class="comment">
							<div class="meta">
								<span><a
									href="showUserAllArticle.action?username=<s:property value='#art.username'/>&id=<s:property value='#art.id'/>"><s:property
		...
		<div class="right_content">
			<div class="user_list">
				...
				<div class="user_listtxt">
					<a class="listlogin" href="showUserAllArticle.action"> <img
