	...
	<body>
		...
		<div class="head">
			...
			<div class="searchbox">
				...
				<a class="searchbutton" href="javascript:"><img src="img/searcbutton.png" /></a>
			</div>
		</div>
		<!--
        	begin:页面主要内容
		...
		<div class="content">
			...
			<div class="register">
				...
				<div class="registerbutton">
					...
					<a id="registerreset" ><img src="img/reset1.png" /></a>
				</div>
			...
			<div class="toplist">
				<div class="list">
					<ul>
						...
						<li class="listtxt">
							<a class= "listlogin"  href="javascript:">
								<span> 登录</span>
							</a>
						</li>

						<li class="listtxt">
							<a class="listregister"  href="javascript:">
								<span> 注册 </span>
							</a>
						</li>
						<li class="listtxt">
